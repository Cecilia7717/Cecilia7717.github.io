...
Education
======
* **B.S. in Computer Science and Pure Mathematics**, Bryn Mawr College  
  Expected May 2026  
  GPA: 3.77/4.0  
  Relevant coursework: Advanced Algorithms, Algorithms for Big Data, Computational Geometry, Software Analysis, Machine Learning, Analysis of Algorithms, Discrete Mathematics, Computational Linguistics, Principles of Programming Languages, Information & Coding Theory, Intro to Computer Systems, Data Structures, Abstract Algebra I–II, Real Analysis I, Linear Algebra, Multivariable Calculus, Evolutionary Game Theory  
...
======
* **Z. Chen** and C. Murphy, *Use of Control Flow Graphs with Edges Consideration for Fault Localization*, 2025.  
  Presented at CAPWIC 2025; paper under submission.

* X. Lu, Z. Wang, **Z. Chen**, J. Lou, C. Wu, Y. Luo, G. Xue, Y. Ji, W. Zhao, and J. Li,  
  *A Blockchain-Based Optimized and Secure Scheduling Framework for Charging Service*, 2024.  
  Submitted for publication.

* **Z. Chen**, O. Weng, S. Qin, J. Agar, N. Tran, and R. Kastner,  
  *Evaluating the Robustness of a 4D STEM Autoencoder to Noisy Inputs*, 2024.  
  Presented at the Fast Machine Learning for Science (FastML) Conference 2024.

Teaching Experience
======
* **Teaching Assistant – Analysis of Algorithms**, Bryn Mawr College  
  Fall 2025  
  Led problem-solving sessions, held office hours, and supported exam preparation.

* **Teaching Assistant – Discrete Mathematics**, Haverford College  
  Aug. 2023 – Jan. 2024; Sept. 2024 – Present  
  Held weekly office and lab hours, assisted with course delivery, and graded assignments for ~28 students.

* **Tutor – Discrete Mathematics**, Bryn Mawr College  
  Sept. 2023 – Jan. 2024  
  Supported students through one-on-one tutoring, prepared materials, and ran review sessions.
